A tool that takes a string input, with words split using a newline character, which then shuffles the list and reads it out using gTTS (Google Text to Speech).
